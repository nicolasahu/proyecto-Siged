                    ...
                    <div class="panel-body">
                      <div class="col-sm-4">
                        ...
                        <form id="formCrearUnidad" action="controlador/CrearUnidades.php" method="post">
                          ...
                          Marca:<input class="form-control onlyLetter" id="nombre" type="text" name="txtmarca" class="form-control" required="">
                          Nº Motor:<input class="form-control onlyNumber" id="nombre" type="text" name="txtmotor" class="form-control" required="">
                          Nº Chasis :<input class="form-control onlyNumber" id="nombre" type="text" name="txtchasis" class="form-control" required="">
                          Nº VIN: <input class="form-control onlyNumber" id="nombre" type="text" name="txtvin" class="form-control" required="">
                          Color:<br><input class="form-control onlyLetter" id="nombre" type="text" name="txtcolor" class="form-control" required="">
                          PPU: <br><input class="form-control " id="nombre" type="text" name="txtppu" class="form-control" required="">
                      ...
                      <div class="col-sm-6" style="margin-left: 60px;">
                        ...
                        Nombre Unidad:<input class="form-control r" id="nombreDeLaUnidadACrear" type="txt" class="form-control" name="txtnombreUnidad" required="">
                        Año de Fabricacion:<input class="form-control onlyNumber" maxlength="4" id="nombre" type="text" class="form-control" name="txtanioFabricacion" required="">
                        ...
                        Capacidad Ocupantes :<input class="form-control onlyNumber" id="nombre" type="number" class="form-control" name="txtcapaocupantes" required="" min="1" pattern="^[0-9]+" onkeydown="javascript: return event.keyCode == 69 ? false : true">
                    ...
                    <div class="panel-body">
                      <div class="col-sm-5">
                        ...
                        <form id="formCrearMantencion" action="controlador/CrearMantencion.php" method="post">
                          ...
                          Responsable:<input class="form-control onlyLetter" id="nombre" type="text" name="txtresponsableMantencion" class="form-control" required="">
                      ...
                      <div class="col-sm-6">
                        ...
                        Dirección: <textarea class="form-control onlyNumbLetter" Type="textarea" name="txtDireccion"></textarea>
                        Comentarios/Observaciones: <textarea class="form-control onlyNumbLetter" Type="textarea" name="txtcomentario"></textarea>
                    ...
                    <div class="panel-body">
                      ...
                      <div class="col-sm-5">
                        ...
                        <form id="formCrearCarguio" action="controlador/CrearCarguioDeCombustible.php" method="post">
                          ...
                          Responsable:<input class="form-control onlyLetter" id="nombre" type="text" name="txtresponsablecombustible" class="form-control" required="">
                          Dirección: <textarea class="form-control onlyNumbLetter" Type="textarea" name="txtDireccionCombustible"></textarea>


                      </div>
                      <div class="col-sm-6">
                        Fecha:<input id="nombre" type="date" name="txtFechaCombustible" class="form-control" required="">
                        Cantidad:<input id="nombre" class="form-control onlyNumber" type="number" name="txtcantidad" class="form-control" required="" min="1" pattern="^[0-9]+" onkeydown="javascript: return event.keyCode == 69 ? false : true">
                        Precio/Litro:<input id="nombre" class="form-control onlyNumber" type="number" name="txtpreciolitro" class="form-control" required="" min="1" pattern="^[0-9]+" onkeydown="javascript: return event.keyCode == 69 ? false : true">
                        Comentarios/Observaciones: <textarea class="form-control onlyNumbLetter" Type="textarea" name="txtcomentario"></textarea>
